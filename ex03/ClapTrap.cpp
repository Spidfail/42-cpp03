...
/*   Updated: 2021/11/29 09:59:26 by guhernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( void )
	: _name("Default"), _hit_points(ClapTrap::_base_hit_points), _nrj_points(ClapTrap::_base_nrj_points), _atk_damage(ClapTrap::_base_atk_damage) {
...
ClapTrap::ClapTrap( std::string const &birthName )
	: _name(birthName), _hit_points(ClapTrap::_base_hit_points), _nrj_points(ClapTrap::_base_nrj_points), _atk_damage(ClapTrap::_base_atk_damage) {
